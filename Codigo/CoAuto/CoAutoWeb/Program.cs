...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        builder.Services.AddTransient<IDevolucaoService, DevolucaoService>();
        ...
        {
            SeedingService seed = new SeedingService(app.Services.CreateScope().ServiceProvider.GetRequiredService<CoAutoContext>());
            seed.Seed();
        }
